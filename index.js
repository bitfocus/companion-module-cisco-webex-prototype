...
class instance extends instance_skel {
	...
	/**
	 * INTERNAL: handle feedback from webex device
	 * 
	 * @access protected
	 */
	webexFeedback(event) {
		console.log("webex feedback", event);
	}
	...
	initConnection() {
		...
		try {
			...
			this.xapi.feedback.on("Status", (event) => this.webexFeedback(event));
